...
if("TRUE" STREQUAL "TRUE")
  set(ratslam_ros_SOURCE_PREFIX /home/drougard/TCOMPgit/RatSlam/sansIrrlicht/src/ratslam_ros)
  set(ratslam_ros_DEVEL_PREFIX /home/drougard/TCOMPgit/RatSlam/sansIrrlicht/devel)
  ...
  set(ratslam_ros_INSTALL_PREFIX /home/drougard/TCOMPgit/RatSlam/sansIrrlicht/install)
...
if(NOT "/home/drougard/TCOMPgit/RatSlam/sansIrrlicht/devel/include" STREQUAL "")
  set(ratslam_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/drougard/TCOMPgit/RatSlam/sansIrrlicht/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'ratslam_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/drougard/TCOMPgit/RatSlam/sansIrrlicht/src/ratslam_ros/${idir}'.  Ask the maintainer 'David Ball <davidmichaelball@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/drougard/TCOMPgit/RatSlam/sansIrrlicht/devel/lib;/home/drougard/TCOMPgit/RatSlam/sansIrrlicht/devel/lib;/home/drougard/TCOMPgit/RatSlam/catkin_ws/devel/lib;/opt/ros/hydro/lib)
...
set(ratslam_ros_EXPORTED_TARGETS "ratslam_ros_generate_messages_cpp;ratslam_ros_generate_messages_lisp;ratslam_ros_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ratslam_ros_dep}_FOUND)
      find_package(${ratslam_ros_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ratslam_ros_dep} REQUIRED ${depend_list})
  endif()
